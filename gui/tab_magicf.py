...
_FONT_BTN    = (FONT_FAMILY, 10, "bold")
_FONT_HINT   = (FONT_FAMILY, 9)
_FONT_SMALL  = (FONT_FAMILY, 7, "bold")
_FONT_REFILL = (FONT_FAMILY, 9, "bold")
...
class TabMagicF:
    ...
    def _build(self):
        ...
        # Lift headers above checkboxes so they aren't overlapped
    ...
    def _toggle_refill(self):
        ...
        if self.refill_mode:
            ...
            # Turning refill OFF also stops any running magic F
